...
export function ResultListPage(props: ResultListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getResults({
        relations: ['client', 'examination'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['award.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'award', header: 'Award', accessorKey: 'award' },
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link
              ...
              href={`/examinations/view/${record.examination?.id}`}
            >
              {record.examination?.name}
            </Link>
          ),
        }
      : null,
